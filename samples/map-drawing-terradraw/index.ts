...
function processSnapshotForUndo(
    ...
    try {
        ...
        map.addListener('projection_changed', () => {
            ...
            draw.on('ready', () => {
                ...
                if (uploadButton && uploadInput) {
                    uploadButton.onclick = () => {
                        (uploadInput as HTMLInputElement).click();
                    };

                    (uploadInput as HTMLInputElement).onchange = (event) => {
            ...
            function rotateFeature(
                ...
                const coordinates = (
                    newFeature.geometry as { coordinates: number[][][] }
                ).coordinates;
            ...
            function getCenter(coordinates: number[][][]): number[] {
                let x = 0;
                let y = 0;
                let count = 0;
