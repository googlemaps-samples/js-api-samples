...
const App = () => (
 <APIProvider apiKey={API_KEY} libraries={['maps', 'places', 'marker', 'geometry', 'core']} version="weekly">
  <PlacesSearchLayout />
 </APIProvider>
);
 ...
 return (
  <>
   <div className="map-container">
    <Map internalUsageAttributionIds={["gmp_git_jsapisamples_v1_react-ui-kit"]}    defaultCenter={{lat: 48.8566, lng: 2.3522}}
     defaultZoom={14}
     mapId="DEMO_MAP_ID"
   ...
   <div className="controls">
     <input type="text" ref={queryInputRef} className="query-input" />
