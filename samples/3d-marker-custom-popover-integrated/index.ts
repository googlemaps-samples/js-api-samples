...
// @ts-nocheck
// [START maps_3d_marker_custom_popover_integrated]
async function init() {
  ...
  content.textContent = 'Popover opened by default!';
  popover.append(content);

  map.append(marker);
  map.append(popover);

  // Toggle popover on marker click
...
<gmp-map-3d range="500" tilt="67.5" center="37.4239163,-122.09435" mode="SATELLITE">
  ...
  <gmp-popover position-anchor="marker-1" light-dismiss-disabled open>
    <div class="popover-content">Popover opened by default!</div>
  </gmp-popover>
</gmp-map-3d>
*/
// [END maps_3d_marker_custom_popover_integrated]
