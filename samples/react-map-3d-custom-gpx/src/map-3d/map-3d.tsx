...
export type Map3DProps = google.maps.maps3d.Map3DElementOptions & {
  ...
  onMapClick?: (event: google.maps.maps3d.LocationClickEvent) => void;
};
  ...
  (
    ...
    useEffect(() => {
      ...
      const handleClick = (event: Event) => {
        ...
        props.onMapClick?.(event as google.maps.maps3d.LocationClickEvent);
      };
    ...
    return (
      <gmp-map-3d
        ...
        tilt={props.tilt}
        roll={props.roll}
        mapId={'749ac551edae0fb4db1de90e'}
        mode="HYBRID">
        {children}
      </gmp-map-3d>
    );
