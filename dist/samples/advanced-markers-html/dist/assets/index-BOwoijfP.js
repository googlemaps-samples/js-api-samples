(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();async function e(){let[{Map:e},{AdvancedMarkerElement:i}]=await Promise.all([google.maps.importLibrary(`maps`),google.maps.importLibrary(`marker`)]),a=new e(document.getElementById(`map`),{zoom:11,center:{lat:37.43238031167444,lng:-122.16795397128632},mapId:`4504f8b37365c3d0`});for(let e of r){let r=new i({map:a,content:n(e),position:e.position,title:e.description,gmpClickable:!0});r.addEventListener(`gmp-click`,()=>{t(r)})}}function t(e){let t=e.children[0];t.classList.contains(`highlight`)?(t.classList.remove(`highlight`),e.zIndex=null):(t.classList.add(`highlight`),e.zIndex=1)}function n(e){let t=document.createElement(`div`);return t.classList.add(`property`),t.innerHTML=`
    <div class="icon">
    ...
    <div class="details">
        ...
        <div>
            ...
            <span>${String(e.bed)}</span>
        </div>
        <div>
            <i aria-hidden="true" class="fa fa-bath fa-lg bath" title="bathroom"></i>
            <span class="fa-sr-only">bathroom</span>
            <span>${String(e.bath)}</span>
        </div>
        <div>
            <i aria-hidden="true" class="fa fa-ruler fa-lg size" title="size"></i>
            <span class="fa-sr-only">size</span>
            <span>${String(e.size)} ft<sup>2</sup></span>
        </div>
        </div>
    </div>
