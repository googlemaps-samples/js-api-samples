...
const PlaceDetails = ({ placeId }) => {
    ...
    return React.createElement("div", { ref: containerRef, className: "place-details-container" });
};
const App = () => {
    return (React.createElement(APIProvider, { apiKey: API_KEY, libraries: ['places'] },
        React.createElement("div", { className: "places-ui-kit" },
            React.createElement(PlaceDetails, { placeId: "ChIJ5bx0qiVu5kcRs_dMpI5ttiY" }))));
};
export default App;
