...
const PlacesSearchLayout = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "map-container" },
            React.createElement(Map, { defaultCenter: { lat: 48.8566, lng: 2.3522 }, defaultZoom: 14, mapId: "DEMO_MAP_ID", clickableIcons: false, onClick: () => {
                    setSelectedPlace(null);
                } },
                React.createElement(PlaceSearchController, { placeSearchRef: placeSearchRef, query: query, setPlaces: setPlaces, setSelectedPlace: setSelectedPlace, selectedPlace: selectedPlace }),
        ...
        React.createElement("div", { className: "controls" },
            React.createElement("input", { type: "text", ref: queryInputRef, className: "query-input" }),
            React.createElement("button", { className: "search-button", onClick: handleSearch }, "Search"))));
};
